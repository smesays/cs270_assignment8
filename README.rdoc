...
At this point, we should have the basics of our model functionality to start
using in the controllers and views.  Thus, in this assignment, we will start to
setup our app controllers and views.
...
REQUEST METHOD     URL          CONTROLLER/ACTION
--------------     ---          -----------------
GET                '/events'    events#show_all_events
GET                '/event/:id' events#show_event
POST               '/event/new' events#create_events
                   ...
